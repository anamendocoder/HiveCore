...
#[derive(Debug)]
pub struct HiveCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HiveCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HiveCore processing");
    
    let mut processor = HiveCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HiveCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HiveCoreProcessor::new(false);
